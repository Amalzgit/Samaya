...
adminBrand_route.post('/create-brand',  uploadBrand.single('brandLogo'),isAdmin, brandValidator, adminBrandController.createBrand);
adminBrand_route.get('/edit-brand/:brandId', isAdmin, adminBrandController.loadEditBrand);
adminBrand_route.post('/edit-brand/:brandId',  uploadBrand.single('brandLogo'), isAdmin, brandValidator,adminBrandController.editBrand);
